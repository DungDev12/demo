      ...
      {step <= 9 ? (
        ...
        <div className="px-[15px]">
          ...
          <div className="bg-[#aed6b8] text-[#155724] p-[20px] text-center text-[14px] leading-relaxed mb-[20px]">
            ...
            <p>3. Mã quà tặng sẽ tùy vào điều kiện để sử dụng, có thời hạn.</p>
            <p>4. Mã quà tặng sẽ có giá trị ngẫu nhiên hoặc cố định .</p>
            <p>
              5. Mã quà tặng chỉ được áp dụng cho thành viên của CHANLEBANK.BET
              .
            </p>
          </div>
        </div>
        ...
        <div className="px-[15px]">
          ...
          <div className="bg-[#aed6b8] text-[#155724] p-[20px] text-center text-[14px] leading-relaxed mb-[20px]">
            <p>
              SỰ KIỆN HOÀN CƯỢC là chương trình đặc biệt mà CLMM.BET dành riêng
              cho các người chơi mới nhằm trải nghiệm dịch vụ của chúng tôi. Khi
              bạn chơi game trên CLMM.BET với tổng cược đạt 50,000 vnđ và BẤT KỂ
              THẮNG THUA bạn sẽ nhận lại 20,000 vnđ.
            </p>
          </div>
        </div>
      ) : (
