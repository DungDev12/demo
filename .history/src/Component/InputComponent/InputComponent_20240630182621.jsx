...
const InputComponent = ({ nameI, label, type, valueOut }) => {
  ...
  return (
    <div>
      <div
        className={`relative flex items-center justify-start gap-2 shadow-[rgba(17, 17, 26, 0.1) 0px 4px 16px, rgba(17, 17, 26, 0.1) 0px 8px 24px, rgba(17, 17, 26, 0.1) 0px 16px 56px] border-[1px] border-black my-2 p-2 rounded-[4px] group ${
