    ...
    <>
      <div className="w-full min-h-[90em]  ">
        <div className="bg-[#ffffff] w-[1140px] mx-auto content rounded-[5px] content min-h-[60em] relative z-[2] mt-[26px] pt-[30px] px-[25px] pb-[40px]">
          ...
          <div className="grid grid-cols-2 auto-cols-max items-start justify-center gap-[30px] mt-[22px]">
            <div className="border-[#E77F08] w-full h-full border-[1px] rounded-[4px] w-[50%] flex flex-col">
