      ...
      <div className="border-[#E77F08] border-[1px] rounded-[4px] w-[50%]">
        ...
        <div className="px-[15px]">
          ...
          <div className="my-[20px] text-[14px]">
            <h4 className="uppercase text-center text-[18px]" style={{textTransform: "uppercase" , t}}>
          ...
          {db && db.albert != null ? <div dangerouslySetInnerHTML={{ __html: db.albert }} /> : ""}
          {/* {db != null && db.albert && (
            <div dangerouslySetInnerHTML={{ __html: db.albert }} />
          )} */}
