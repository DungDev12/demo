          ...
          <div className="mt-[15px] text-center">
            ...
            <div>
              <h4 className="flex items-center gap-2 justify-center">
                <span className="px-[8px]  pb-[4px] rounded-[4px] text-[#FFFFFF] bg-[#5CB85C]">
                  KẾT QUẢ
                </span>
                {" = "}
                <span className="px-[8px]  pb-[4px] rounded-[4px] text-[#FFFFFF] bg-[#F0AD4E]">
                  MÃ THAM CHIẾU
                </span>
                <span className="px-[8px]  pb-[4px] rounded-[4px] text-[#FFFFFF] bg-[#5BC0DE]">
                  +
                </span>
                <span className="px-[8px]  pb-[4px] rounded-[4px] text-[#FFFFFF] bg-[#D9534F]">
                  0
                </span>
              </h4>
            </div>
