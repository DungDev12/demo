  ...
  return (
    <>
      <div className=" w-full min-h-[90em] bg-[#E6E6E6] px-[275px] ">
        <div className="bg-[#ffffff] content rounded-[5px] content min-h-[60em] relative z-[2] mt-[26px]  px-[25px] pb-[40px]">
          <div className="min-h-[80px] text-center relative pt-[30px]">
