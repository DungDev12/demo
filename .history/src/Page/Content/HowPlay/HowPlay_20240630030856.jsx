    ...
    <>
      <div className="border-[#E77F08] border-[1px] rounded-[4px] w-[50%]">
        ...
        {step <= 9 ? (
          ...
          <div>
            <p className="uppercase text-[18px] text-center mt-[02px] font-bold text-[#155724]">
              code khuyến mại
            </p>
            <form className="w-[50%] mx-auto p-4">
              <InputComponent
                nameI="code"
                label="Mã code"
              ...
              />
              <div>
                <button className="bg-[#5CB85C] text-[#FFFFFF] py-[5px] px-[15px] rounded-[4px] mt-[10px] block mx-auto">
                  Kiểm tra
                </button>
              </div>
            </form>
