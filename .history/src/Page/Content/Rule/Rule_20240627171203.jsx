  ...
  return (
    <>
      <div className="border-[#F0AD4E] border-[1px] rounded-[4px] text-center p-[5px]">
        ...
        <h3><img alt="enlightened" src="https://cdn.ckeditor.com/4.21.0/full/plugins/smiley/images/lightbulb.png" title="enlightened">&nbsp;CLMM, CHẴN LẺ MOMO LÀ GÌ<strong>&nbsp; ?</strong> /</img></h3>
      </div>
    </>
  );
};
