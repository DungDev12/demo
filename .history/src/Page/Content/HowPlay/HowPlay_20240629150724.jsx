      ...
      <div className="border-[#E77F08] border-[1px] rounded-[4px] w-[50%]">
        ...
        <div className="px-[15px]">
          ...
          <div className="mt-[20px]">
            <h4 className="uppercase text-center text-[14px]">
            ...
            <p><strong>VD: Kết quả là :&nbsp;&nbsp;xxx69883&nbsp;=&gt; kết quả là 3</strong></p>
            <p><strong>Chẵn lẻ - Tài xỉu là game tỉ lệ cao, không tính&nbsp;0&nbsp;và&nbsp;9&nbsp;, nếu muốn tính 0 và 9 vui lòng chơi chẵn lẻ 2 !</strong></p>
          </div>
        </div>
      </div>
    </>
