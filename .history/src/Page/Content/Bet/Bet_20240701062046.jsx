    ...
    <>
      <div className="border-[#E77F08] border-[1px] rounded-[4px] w-[50%] p-[15px]">
        ...
        <div className="text-center">
          ...
          <input
            name="tran_id"
            className="block w-[90%] mx-auto border-black border-[1px] rounded-[4px] text-[16px] mt-[1rem] mb-[0.3rem] px-2 py-1"
            onChange={handleOnChange}
            value={value}
            placeholder="Mã giao dịch hoặc mã phiên: Ví dụ 58438383257"
          />
          <small className="text-[12px] text-gray-">Nhập mã giao dịch để kiểm tra.</small>
        </div>
      </div>
    </>
  );
