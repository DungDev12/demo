...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="w-full sticky top-[63px] z-[3] pl-[275px] relative">
        <marquee className="pointer-events-none Font text-[#ffffff] cursor-pointer overflow-hidden absolute">
          <b>
            <p>
              <strong>
