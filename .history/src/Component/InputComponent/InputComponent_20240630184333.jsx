...
const InputComponent = ({ nameI, label, type, placeholder, valueOut }) => {
    ...
    <div>
      ...
      >
        <p
          className={`absolute ${
            input !== ""
              ? "top-[-8px] text-[14px] left-[10px]"
              : "top-[10.5px] left-[10px] text-[17.5px]"
        ...
        <input
          name={nameI}
          className={`outline-none w-full group-focus-within:text-left text-right `}
          type={type}
