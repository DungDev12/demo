...
const InputComponent = ({ nameI, label, type, valueOut }) => {
  ...
  return (
    <div>
      <div className="relative flex items-center justify-start gap-2 border-[1px] border-black mt-2 mb-2 p-2 rounded-[4px] group">
        <p
          className={`absolute ${
            input !== ""
      ...
      <p className="text-center text-[14px]">err</p>
    </div>
  );
};
