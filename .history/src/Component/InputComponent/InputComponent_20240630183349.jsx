...
const InputComponent = ({ nameI, label, type, valueOut }) => {
  ...
  return (
    <div>
      <div
        className={`relative flex items-center justify-start gap-2 forshadow-lg shadow-blue-500/50 showShadow border-[1px] border-black my-2 p-2 rounded-[4px] group ${
