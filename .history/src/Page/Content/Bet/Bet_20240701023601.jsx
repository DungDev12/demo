    ...
    <>
      <div className="border-[#E77F08] border-[1px] rounded-[4px] w-[50%]">
        ...
        <div className="grid grid-cols-2 gap-[20px]">
          <button className="bg-[#000000] w-[20%] ">C</button>
          <button className="bg-[#000000] w-[20%] ">L</button>
          <button className="bg-[#000000] w-[20%] ">T</button>
          <button className="bg-[#000000] w-[20%] ">X</button>
        </div>
      </div>
    </>
  );
