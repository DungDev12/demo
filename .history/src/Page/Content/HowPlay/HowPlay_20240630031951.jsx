      ...
      <div className="border-[#E77F08] border-[1px] rounded-[4px] w-[50%]">
        ...
        {step <= 9 ? (
          ...
          <div className="px-[15px]">
            ...
            <div className="bg-[#aed6b8] text-[#155724] p-[20px]">
            <p>1. Mã quà tặng là chương trình chi ân dành riêng cho khách hàng CHANLEBANK.BET<br>2. Mã quà tặng có thể nhận được tại các sự kiện hoặc hoàn thành nhiệm vụ do CHANLEBANK.BET tổ chức.<br>3. Mã quà tặng sẽ tùy vào điều kiện để sử dụng, có thời hạn.<br><br>4. Mã quà tặng sẽ có giá trị ngẫu nhiên hoặc cố định .<br>5. Mã quà tặng chỉ được áp dụng cho thành viên của CHANLEBANK.BET.</p>
            </div>
          </div>
        ) : step == 11 ? (
          "11"
