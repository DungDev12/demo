...
const History = () => {
  ...
  //       console.log(response.data.Settings._historyBetGame);
  //       setHistoryData(response.data.Settings._historyBetGame);
  //     } else {
  ...
  return (
    <>
      <div className="border-[1px] rounded-[4px] border-[#E77F08] text-center mt-ơ20px">
