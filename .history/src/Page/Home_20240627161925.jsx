...
const Home = () => {
  ...
  return (
    <>
      <div className=" w-full min-h-[90em] bg-[#E6E6E6] ">
        <div className="bg-[#ffffff] w-[1140px] mx-auto content rounded-[5px] content min-h-[60em] relative z-[2] mt-[26px] pt-[30px] px-[25px] pb-[40px]">
          ...
          <div className="mt-[15px] text-center">
            <div className="text-[14px]">
              <p>
                CHỨNG THỰC MD5 : <span className="font-bold">0</span>
              </p>
            </div>
            <div>
              <h4 className="flex items-center gap-2 jus">
                <span className="px-[13px] py-[6px] rounded-[4px] text-[#FFFFFF] bg-[#5CB85C]">
                  KẾT QUẢ
                </span>
                {" = "}
                <span className="px-[13px] py-[6px] rounded-[4px] text-[#FFFFFF] bg-[#F0AD4E]">
                  MÃ THAM CHIẾU
                </span>{" "}
                <span className="px-[13px] py-[6px] rounded-[4px] text-[#FFFFFF] bg-[#5BC0DE]">
                  +
                </span>{" "}
                <span className="px-[13px] py-[6px] rounded-[4px] text-[#FFFFFF] bg-[#D9534F]">
                  0
                </span>
              </h4>
            </div>
