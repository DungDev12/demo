        ...
        {step <= 9 ? (
          ...
          <div className="px-[15px]">
            ...
            <div className="bg-[#aed6b8] text-[#155724] p-[20px]">
              ...
              <p>
                3. Mã quà tặng sẽ tùy vào điều kiện để sử dụng, có thời hạn. 4.
                Mã quà tặng sẽ có giá trị ngẫu nhiên hoặc cố định . 5. Mã quà
                tặng chỉ được áp dụng cho thành viên của CHANLEBANK.BET.
              </p>
            </div>
          </div>
        ) : step == 11 ? (
